...
/*
 This environment allows replacing `swift_task_enqueueGlobal_hook` global function
...
public enum ConcurrencyEnvironment {
    ...
    private static let _swift_task_enqueueGlobal_hook = dlsym(dlopen(nil, RTLD_LAZY), "swift_task_enqueueGlobal_hook")
