...
struct DeepLinkRouteCoderTests {
    ...
    private let testSeed = MailboxMessageSeed(localId: .init(value: 22), subject: "foo bar 😀")
    private let testURL = URL(string: "protonmailET://messages/22?subject=foo%20bar%20%F0%9F%98%80")!
