    ...
    enum Settings {
        enum AppIcon {
            ...
            static let description = LocalizedStringResource(
                "Keep the default Proton Mail icon, or disguise it with a more discreet one for extra privacy. Notifications will always show the Proton Mail name and icon.\n[Learn more...](https://proton.me/support/disguise-app-icon)",
