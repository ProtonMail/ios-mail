...
struct SearchScreen: View {
    ...
    init(userSession: MailUserSession, loadingBarStateStore: LoadingBarStateStore) {
        _model = StateObject(wrappedValue: .init(loadingBarStateStore: loadingBarStateStore))
