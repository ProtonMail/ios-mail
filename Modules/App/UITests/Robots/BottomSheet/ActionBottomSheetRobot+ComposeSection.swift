...
private struct Identifiers {
    static let replyButton = "actionPicker.compose.reply"
    static let replyAllButton = "actionPicker.compose.replyAll"
    static let forwardButton = "actionPicker.compose.forward"
}
