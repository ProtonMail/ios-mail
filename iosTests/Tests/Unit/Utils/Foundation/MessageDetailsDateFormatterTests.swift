...
class MessageDetailsDateFormatterTests: BaseTestCase {
    ...
    func testString_ForGivenDate_ReturnsCorrectlyFormattedDate() {
        let testCases: [TestCase] = [
            .init(given: .fixture("2022-05-09 14:17:22"), expected: "May 9, 2022 at 16:17:22"),
            .init(given: .fixture("2024-01-30 08:11:45"), expected: "Jan 30, 2024 at 9:11:45"),
            .init(given: .fixture("2017-10-30 22:49:33"), expected: "Oct 30, 2017 at 23:49:33"),
            .init(given: .fixture("2024-12-31 03:59:59"), expected: "Dec 31, 2024 at 4:59:59")
        ]
...
private extension TimeZone {
    ...
    static let warsaw: TimeZone = TimeZone(identifier: "Europe/Warsaw").unsafelyUnwrapped
}
