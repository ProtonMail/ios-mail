...
uint64_t uniffi_proton_mail_uniffi_fn_method_mailusersession_image_for_sender(void*_Nonnull ptr, RustBuffer sender, RustBuffer size, RustBuffer mode, RustBuffer format
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_PROTON_MAIL_UNIFFI_FN_METHOD_MAILUSERSESSION_IMAGE_FOR_SENDERS
#define UNIFFI_FFIDEF_UNIFFI_PROTON_MAIL_UNIFFI_FN_METHOD_MAILUSERSESSION_IMAGE_FOR_SENDERS
uint64_t uniffi_proton_mail_uniffi_fn_method_mailusersession_image_for_senders(void*_Nonnull ptr, RustBuffer senders, RustBuffer size, RustBuffer mode, RustBuffer format
);
#endif
...
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_PROTON_MAIL_UNIFFI_CHECKSUM_METHOD_MAILUSERSESSION_IMAGE_FOR_SENDERS
#define UNIFFI_FFIDEF_UNIFFI_PROTON_MAIL_UNIFFI_CHECKSUM_METHOD_MAILUSERSESSION_IMAGE_FOR_SENDERS
uint16_t uniffi_proton_mail_uniffi_checksum_method_mailusersession_image_for_senders(void
