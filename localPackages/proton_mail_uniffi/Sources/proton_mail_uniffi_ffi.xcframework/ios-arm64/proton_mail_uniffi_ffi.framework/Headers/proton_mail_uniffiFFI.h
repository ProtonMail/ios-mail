...
uint64_t uniffi_proton_mail_uniffi_fn_method_mailusersession_conversation_with_id_and_context(void*_Nonnull ptr, uint64_t id, uint64_t label_id
);
#endif
...
uint64_t uniffi_proton_mail_uniffi_fn_method_mailusersession_conversation_with_id_with_all_mail_context(void*_Nonnull ptr, uint64_t id
);
#endif
...
uint64_t uniffi_proton_mail_uniffi_fn_method_mailusersession_conversation_with_remote_id(void*_Nonnull ptr, RustBuffer id
);
#endif
...
uint64_t uniffi_proton_mail_uniffi_fn_method_mailusersession_filter_conversations(void*_Nonnull ptr, RustBuffer filter, uint64_t label_id
);
#endif
...
uint64_t uniffi_proton_mail_uniffi_fn_method_mailusersession_message_metadata_with_remote_id(void*_Nonnull ptr, RustBuffer remote_id
);
#endif
