...
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_PROTON_MAIL_UNIFFI_FN_METHOD_MAILBOX_GET_IMAGE_FOR_CONVERSATION
#define UNIFFI_FFIDEF_UNIFFI_PROTON_MAIL_UNIFFI_FN_METHOD_MAILBOX_GET_IMAGE_FOR_CONVERSATION
uint64_t uniffi_proton_mail_uniffi_fn_method_mailbox_get_image_for_conversation(void*_Nonnull ptr, uint64_t conversation_id, RustBuffer size, RustBuffer mode
);
#endif
...
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_PROTON_MAIL_UNIFFI_CHECKSUM_METHOD_MAILBOX_GET_IMAGE_FOR_CONVERSATION
#define UNIFFI_FFIDEF_UNIFFI_PROTON_MAIL_UNIFFI_CHECKSUM_METHOD_MAILBOX_GET_IMAGE_FOR_CONVERSATION
uint16_t uniffi_proton_mail_uniffi_checksum_method_mailbox_get_image_for_conversation(void
