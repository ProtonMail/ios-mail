...
uint64_t uniffi_proton_mail_uniffi_fn_method_mailusersession_image_for_sender(void*_Nonnull ptr, RustBuffer address, RustBuffer bimi_selector, int8_t display_sender_image, RustBuffer size, RustBuffer mode, RustBuffer format
);
#endif
