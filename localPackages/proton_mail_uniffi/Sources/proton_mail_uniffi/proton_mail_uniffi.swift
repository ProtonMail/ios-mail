...
public class LoginFlow:
     ...
     * Check whether the login flow is awaiting 2FA input.
     */
    public func isAwaiting2fa()  -> Bool {
     ...
     * Submit 2FA totp code.
     */
    public func submitTotp(code: String) async throws  {
        return try  await uniffiRustCallAsync(
            rustFutureFunc: {
...
public class MailboxConversationLiveQuery:
     ...
     * Get the latest value for this Query.
     */
    public func value()  -> [LocalConversation] {
...
public class StoredSession:
     ...
     * Get the session id.
     */
    public func sessionId()  -> Uid {
        return try!  FfiConverterTypeUid_lift(
            try! 
    rustCall() {
    ...
    public func userId()  -> UserId {
        return try!  FfiConverterTypeUserId_lift(
            try! 
    rustCall() {
...
public enum EventLoopError {
    ...
    fileprivate static func uniffiErrorHandler(_ error: RustBuffer) throws -> Error {
        return try FfiConverterTypeEventLoopError.lift(error)
    }
}
...
public enum LoginFlowError {
    ...
    fileprivate static func uniffiErrorHandler(_ error: RustBuffer) throws -> Error {
        return try FfiConverterTypeLoginFlowError.lift(error)
    }
}
...
public enum MailboxError {
    ...
    fileprivate static func uniffiErrorHandler(_ error: RustBuffer) throws -> Error {
        return try FfiConverterTypeMailboxError.lift(error)
    }
}
...
public enum OsKeyChainError {
    ...
    fileprivate static func uniffiErrorHandler(_ error: RustBuffer) throws -> Error {
        return try FfiConverterTypeOSKeyChainError.lift(error)
    }
}
...
fileprivate let uniffiCallbackHandlerMailUserSessionInitializationCallback : ForeignCallback =
    ...
    switch method {
        ...
        case 1:
            ...
            do {
                return try invokeOnStage(cb, argsData, argsLen, out_buf)
            } catch let error {
...
// Declaration and FfiConverters for MailboxBackgroundResult Callback Interface

fileprivate let uniffiCallbackHandlerMailboxBackgroundResult : ForeignCallback =
    { (handle: UniFFICallbackHandle, method: Int32, argsData: UnsafePointer<UInt8>, argsLen: Int32, out_buf: UnsafeMutablePointer<RustBuffer>) -> Int32 in
    

    func invokeOnBackgroundResult(_ swiftCallbackInterface: MailboxBackgroundResult, _ argsData: UnsafePointer<UInt8>, _ argsLen: Int32, _ out_buf: UnsafeMutablePointer<RustBuffer>) throws -> Int32 {
        var reader = createReader(data: Data(bytes: argsData, count: Int(argsLen)))
        func makeCall() throws -> Int32 {
            swiftCallbackInterface.onBackgroundResult(
                    error:  try FfiConverterOptionTypeMailboxError.read(from: &reader)
                    )
            return UNIFFI_CALLBACK_SUCCESS
        }
        return try makeCall()
    ...
    switch method {
        case IDX_CALLBACK_FREE:
            FfiConverterCallbackInterfaceMailboxBackgroundResult.handleMap.remove(handle: handle)
            // Successful return
            // See docs of ForeignCallback in `uniffi_core/src/ffi/foreigncallbacks.rs`
            return UNIFFI_CALLBACK_SUCCESS
        case 1:
            guard let cb = FfiConverterCallbackInterfaceMailboxBackgroundResult.handleMap.get(handle: handle) else {
                out_buf.pointee = FfiConverterString.lower("No callback in handlemap; this is a Uniffi bug")
                return UNIFFI_CALLBACK_UNEXPECTED_ERROR
            }
            do {
                return try invokeOnBackgroundResult(cb, argsData, argsLen, out_buf)
            } catch let error {
                out_buf.pointee = FfiConverterString.lower(String(describing: error))
                return UNIFFI_CALLBACK_UNEXPECTED_ERROR
            }
...
private func uniffiCallbackInitMailboxBackgroundResult() {
    uniffi_proton_mail_uniffi_fn_init_callback_mailboxbackgroundresult(uniffiCallbackHandlerMailboxBackgroundResult)
}

// FfiConverter protocol for callback interfaces
fileprivate struct FfiConverterCallbackInterfaceMailboxBackgroundResult {
    fileprivate static var handleMap = UniFFICallbackHandleMap<MailboxBackgroundResult>()
}
...
// Declaration and FfiConverters for MailboxLiveQueryUpdatedCallback Callback Interface

fileprivate let uniffiCallbackHandlerMailboxLiveQueryUpdatedCallback : ForeignCallback =
    { (handle: UniFFICallbackHandle, method: Int32, argsData: UnsafePointer<UInt8>, argsLen: Int32, out_buf: UnsafeMutablePointer<RustBuffer>) -> Int32 in
    

    func invokeOnUpdated(_ swiftCallbackInterface: MailboxLiveQueryUpdatedCallback, _ argsData: UnsafePointer<UInt8>, _ argsLen: Int32, _ out_buf: UnsafeMutablePointer<RustBuffer>) throws -> Int32 {
        func makeCall() throws -> Int32 {
            swiftCallbackInterface.onUpdated(
                    )
            return UNIFFI_CALLBACK_SUCCESS
        }
        return try makeCall()
    ...
    switch method {
        case IDX_CALLBACK_FREE:
            FfiConverterCallbackInterfaceMailboxLiveQueryUpdatedCallback.handleMap.remove(handle: handle)
            // Successful return
            // See docs of ForeignCallback in `uniffi_core/src/ffi/foreigncallbacks.rs`
            return UNIFFI_CALLBACK_SUCCESS
        case 1:
            guard let cb = FfiConverterCallbackInterfaceMailboxLiveQueryUpdatedCallback.handleMap.get(handle: handle) else {
                out_buf.pointee = FfiConverterString.lower("No callback in handlemap; this is a Uniffi bug")
                return UNIFFI_CALLBACK_UNEXPECTED_ERROR
            }
            do {
                return try invokeOnUpdated(cb, argsData, argsLen, out_buf)
            } catch let error {
                out_buf.pointee = FfiConverterString.lower(String(describing: error))
                return UNIFFI_CALLBACK_UNEXPECTED_ERROR
            }
...
private func uniffiCallbackInitMailboxLiveQueryUpdatedCallback() {
    uniffi_proton_mail_uniffi_fn_init_callback_mailboxlivequeryupdatedcallback(uniffiCallbackHandlerMailboxLiveQueryUpdatedCallback)
}

// FfiConverter protocol for callback interfaces
fileprivate struct FfiConverterCallbackInterfaceMailboxLiveQueryUpdatedCallback {
    fileprivate static var handleMap = UniFFICallbackHandleMap<MailboxLiveQueryUpdatedCallback>()
}
...
// Declaration and FfiConverters for NetworkStatusChanged Callback Interface

fileprivate let uniffiCallbackHandlerNetworkStatusChanged : ForeignCallback =
    { (handle: UniFFICallbackHandle, method: Int32, argsData: UnsafePointer<UInt8>, argsLen: Int32, out_buf: UnsafeMutablePointer<RustBuffer>) -> Int32 in
    

    func invokeOnNetworkStatusChanged(_ swiftCallbackInterface: NetworkStatusChanged, _ argsData: UnsafePointer<UInt8>, _ argsLen: Int32, _ out_buf: UnsafeMutablePointer<RustBuffer>) throws -> Int32 {
        var reader = createReader(data: Data(bytes: argsData, count: Int(argsLen)))
        func makeCall() throws -> Int32 {
            swiftCallbackInterface.onNetworkStatusChanged(
                    online:  try FfiConverterBool.read(from: &reader)
                    )
            return UNIFFI_CALLBACK_SUCCESS
        }
        return try makeCall()
    ...
    switch method {
        case IDX_CALLBACK_FREE:
            FfiConverterCallbackInterfaceNetworkStatusChanged.handleMap.remove(handle: handle)
            // Successful return
            // See docs of ForeignCallback in `uniffi_core/src/ffi/foreigncallbacks.rs`
            return UNIFFI_CALLBACK_SUCCESS
        case 1:
            guard let cb = FfiConverterCallbackInterfaceNetworkStatusChanged.handleMap.get(handle: handle) else {
                out_buf.pointee = FfiConverterString.lower("No callback in handlemap; this is a Uniffi bug")
                return UNIFFI_CALLBACK_UNEXPECTED_ERROR
            }
            do {
                return try invokeOnNetworkStatusChanged(cb, argsData, argsLen, out_buf)
            } catch let error {
                out_buf.pointee = FfiConverterString.lower(String(describing: error))
                return UNIFFI_CALLBACK_UNEXPECTED_ERROR
            }
...
private func uniffiCallbackInitNetworkStatusChanged() {
    uniffi_proton_mail_uniffi_fn_init_callback_networkstatuschanged(uniffiCallbackHandlerNetworkStatusChanged)
}

// FfiConverter protocol for callback interfaces
fileprivate struct FfiConverterCallbackInterfaceNetworkStatusChanged {
    fileprivate static var handleMap = UniFFICallbackHandleMap<NetworkStatusChanged>()
}
...
// Declaration and FfiConverters for OsKeyChain Callback Interface

fileprivate let uniffiCallbackHandlerOSKeyChain : ForeignCallback =
    { (handle: UniFFICallbackHandle, method: Int32, argsData: UnsafePointer<UInt8>, argsLen: Int32, out_buf: UnsafeMutablePointer<RustBuffer>) -> Int32 in
    

    func invokeStore(_ swiftCallbackInterface: OsKeyChain, _ argsData: UnsafePointer<UInt8>, _ argsLen: Int32, _ out_buf: UnsafeMutablePointer<RustBuffer>) throws -> Int32 {
        var reader = createReader(data: Data(bytes: argsData, count: Int(argsLen)))
        func makeCall() throws -> Int32 {
            try swiftCallbackInterface.store(
        ...
        do {
            return try makeCall()
        } catch let error as OsKeyChainError {
            out_buf.pointee = FfiConverterTypeOSKeyChainError.lower(error)
            return UNIFFI_CALLBACK_ERROR
        }
    }

    func invokeDelete(_ swiftCallbackInterface: OsKeyChain, _ argsData: UnsafePointer<UInt8>, _ argsLen: Int32, _ out_buf: UnsafeMutablePointer<RustBuffer>) throws -> Int32 {
        func makeCall() throws -> Int32 {
            try swiftCallbackInterface.delete(
                    )
            return UNIFFI_CALLBACK_SUCCESS
        }
        do {
    ...
    func invokeGet(_ swiftCallbackInterface: OsKeyChain, _ argsData: UnsafePointer<UInt8>, _ argsLen: Int32, _ out_buf: UnsafeMutablePointer<RustBuffer>) throws -> Int32 {
        func makeCall() throws -> Int32 {
    ...
    switch method {
        case IDX_CALLBACK_FREE:
            FfiConverterCallbackInterfaceOsKeyChain.handleMap.remove(handle: handle)
            // Successful return
            // See docs of ForeignCallback in `uniffi_core/src/ffi/foreigncallbacks.rs`
            return UNIFFI_CALLBACK_SUCCESS
        case 1:
            guard let cb = FfiConverterCallbackInterfaceOsKeyChain.handleMap.get(handle: handle) else {
                out_buf.pointee = FfiConverterString.lower("No callback in handlemap; this is a Uniffi bug")
                return UNIFFI_CALLBACK_UNEXPECTED_ERROR
            }
            do {
                return try invokeStore(cb, argsData, argsLen, out_buf)
            } catch let error {
                out_buf.pointee = FfiConverterString.lower(String(describing: error))
                return UNIFFI_CALLBACK_UNEXPECTED_ERROR
            }
...
private func uniffiCallbackInitOSKeyChain() {
    uniffi_proton_mail_uniffi_fn_init_callback_oskeychain(uniffiCallbackHandlerOSKeyChain)
}

// FfiConverter protocol for callback interfaces
fileprivate struct FfiConverterCallbackInterfaceOsKeyChain {
    fileprivate static var handleMap = UniFFICallbackHandleMap<OsKeyChain>()
}
...
// Declaration and FfiConverters for SessionCallback Callback Interface

fileprivate let uniffiCallbackHandlerSessionCallback : ForeignCallback =
    { (handle: UniFFICallbackHandle, method: Int32, argsData: UnsafePointer<UInt8>, argsLen: Int32, out_buf: UnsafeMutablePointer<RustBuffer>) -> Int32 in
    

    func invokeOnSessionRefresh(_ swiftCallbackInterface: SessionCallback, _ argsData: UnsafePointer<UInt8>, _ argsLen: Int32, _ out_buf: UnsafeMutablePointer<RustBuffer>) throws -> Int32 {
        func makeCall() throws -> Int32 {
            swiftCallbackInterface.onSessionRefresh(
                    )
            return UNIFFI_CALLBACK_SUCCESS
        }
        return try makeCall()
    ...
    func invokeOnSessionDeleted(_ swiftCallbackInterface: SessionCallback, _ argsData: UnsafePointer<UInt8>, _ argsLen: Int32, _ out_buf: UnsafeMutablePointer<RustBuffer>) throws -> Int32 {
        func makeCall() throws -> Int32 {
            swiftCallbackInterface.onSessionDeleted(
                    )
            return UNIFFI_CALLBACK_SUCCESS
        }
        return try makeCall()
    ...
    func invokeOnRefreshFailed(_ swiftCallbackInterface: SessionCallback, _ argsData: UnsafePointer<UInt8>, _ argsLen: Int32, _ out_buf: UnsafeMutablePointer<RustBuffer>) throws -> Int32 {
        var reader = createReader(data: Data(bytes: argsData, count: Int(argsLen)))
        func makeCall() throws -> Int32 {
            swiftCallbackInterface.onRefreshFailed(
                    e:  try FfiConverterTypeSessionError.read(from: &reader)
                    )
            return UNIFFI_CALLBACK_SUCCESS
        }
        return try makeCall()
    ...
    func invokeOnError(_ swiftCallbackInterface: SessionCallback, _ argsData: UnsafePointer<UInt8>, _ argsLen: Int32, _ out_buf: UnsafeMutablePointer<RustBuffer>) throws -> Int32 {
        var reader = createReader(data: Data(bytes: argsData, count: Int(argsLen)))
        func makeCall() throws -> Int32 {
            swiftCallbackInterface.onError(
                    err:  try FfiConverterTypeSessionError.read(from: &reader)
                    )
            return UNIFFI_CALLBACK_SUCCESS
        }
        return try makeCall()
    ...
    switch method {
        case IDX_CALLBACK_FREE:
            FfiConverterCallbackInterfaceSessionCallback.handleMap.remove(handle: handle)
            // Successful return
            // See docs of ForeignCallback in `uniffi_core/src/ffi/foreigncallbacks.rs`
            return UNIFFI_CALLBACK_SUCCESS
        case 1:
            guard let cb = FfiConverterCallbackInterfaceSessionCallback.handleMap.get(handle: handle) else {
                out_buf.pointee = FfiConverterString.lower("No callback in handlemap; this is a Uniffi bug")
                return UNIFFI_CALLBACK_UNEXPECTED_ERROR
            }
            do {
                return try invokeOnSessionRefresh(cb, argsData, argsLen, out_buf)
            } catch let error {
                out_buf.pointee = FfiConverterString.lower(String(describing: error))
                return UNIFFI_CALLBACK_UNEXPECTED_ERROR
            }
        case 2:
            ...
            do {
                return try invokeOnSessionDeleted(cb, argsData, argsLen, out_buf)
            } catch let error {
                out_buf.pointee = FfiConverterString.lower(String(describing: error))
                return UNIFFI_CALLBACK_UNEXPECTED_ERROR
            }
        case 3:
            ...
            do {
                return try invokeOnRefreshFailed(cb, argsData, argsLen, out_buf)
            } catch let error {
                out_buf.pointee = FfiConverterString.lower(String(describing: error))
                return UNIFFI_CALLBACK_UNEXPECTED_ERROR
            }
...
private func uniffiCallbackInitSessionCallback() {
    uniffi_proton_mail_uniffi_fn_init_callback_sessioncallback(uniffiCallbackHandlerSessionCallback)
}

// FfiConverter protocol for callback interfaces
fileprivate struct FfiConverterCallbackInterfaceSessionCallback {
    fileprivate static var handleMap = UniFFICallbackHandleMap<SessionCallback>()
}
...
public func locateBlockquote(input: String)  -> LocateBlockquoteResult {
    return try!  FfiConverterTypeLocateBlockquoteResult.lift(
        try! rustCall() {
...
private var initializationResult: InitializationResult {
    ...
    if (uniffi_proton_mail_uniffi_checksum_func_locate_blockquote() != 29543) {
    ...
    if (uniffi_proton_mail_uniffi_checksum_method_loginflow_login() != 50659) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_proton_mail_uniffi_checksum_method_networkstatuschanged_on_network_status_changed() != 26288) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_proton_mail_uniffi_checksum_method_oskeychain_store() != 30020) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_proton_mail_uniffi_checksum_method_sessioncallback_on_refresh_failed() != 22240) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_proton_mail_uniffi_checksum_method_sessioncallback_on_error() != 19595) {
        return InitializationResult.apiChecksumMismatch
    }
