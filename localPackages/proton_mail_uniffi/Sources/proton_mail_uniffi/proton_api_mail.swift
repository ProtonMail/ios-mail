...
public struct Label {
    ...
    public var notify: ProtonBoolean
    public var display: ProtonBoolean
    public var sticky: ProtonBoolean
    public var expanded: ProtonBoolean
    ...
    public init(
        ...
        color: String, 
        labelType: LabelType, 
        notify: ProtonBoolean, 
        display: ProtonBoolean, 
        sticky: ProtonBoolean, 
        expanded: ProtonBoolean, 
        order: UInt32) {
        self.id = id
...
public struct FfiConverterTypeLabel: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> Label {
        return
            try Label(
                ...
                notify: FfiConverterTypeProtonBoolean.read(from: &buf), 
                display: FfiConverterTypeProtonBoolean.read(from: &buf), 
                sticky: FfiConverterTypeProtonBoolean.read(from: &buf), 
                expanded: FfiConverterTypeProtonBoolean.read(from: &buf), 
    ...
    public static func write(_ value: Label, into buf: inout [UInt8]) {
        ...
        FfiConverterTypeProtonBoolean.write(value.notify, into: &buf)
        FfiConverterTypeProtonBoolean.write(value.display, into: &buf)
        FfiConverterTypeProtonBoolean.write(value.sticky, into: &buf)
        FfiConverterTypeProtonBoolean.write(value.expanded, into: &buf)
...
public struct MailSettings {
    ...
    public var autoSaveContacts: ProtonBoolean
    ...
    public var shortcuts: ProtonBoolean
    public var pmSignature: MailSettingsPmSignature
    public var pmSignatureReferralLink: ProtonBoolean
    ...
    public var enableFolderColor: ProtonBoolean
    public var inheritParentFolderColor: ProtonBoolean
    public var submissionAccess: ProtonBoolean
    public var rightToLeft: MailSettingsComposerDirection
    public var attachPublicKey: ProtonBoolean
    public var sign: ProtonBoolean
    public var pgpScheme: MailSettingsPgpScheme
    public var promptPin: ProtonBoolean
    public var stickyLabels: ProtonBoolean
    public var confirmLink: ProtonBoolean
    public var delaySendSeconds: UInt32
    public var fontFace: String?
    public var spamAction: MailSettingsSpamAction?
    public var blockSenderConfirmation: ProtonBoolean?
    public var mobileSettings: MailSettingsMobileSettings?
    public var hideRemoteImages: ProtonBoolean
    public var hideSenderImages: ProtonBoolean
    ...
    public init(
        ...
        signature: String, 
        theme: String, 
        autoSaveContacts: ProtonBoolean, 
        composerMode: MailSettingsComposerMode, 
        messageButtons: MailSettingsMessageButtons, 
        showImages: MailSettingsShowImages, 
        showMoved: MailSettingsShowMoved, 
        autoDeleteSpamAndTrashDays: UInt32?, 
        almostAllMail: MailSettingsAlmostAllMail, 
        nextMessageOnMove: MailSettingsNextMessageOnMove?, 
        viewMode: MailSettingsViewMode, 
        viewLayout: MailSettingsViewLayout, 
        swipeLeft: MailSettingsSwipeAction, 
        swipeRight: MailSettingsSwipeAction, 
        shortcuts: ProtonBoolean, 
        pmSignature: MailSettingsPmSignature, 
        pmSignatureReferralLink: ProtonBoolean, 
        imageProxy: UInt32, 
        numMessagePerPage: UInt32, 
        draftMimeType: String, 
        receiveMimeType: String, 
        showMimeType: String, 
        enableFolderColor: ProtonBoolean, 
        inheritParentFolderColor: ProtonBoolean, 
        submissionAccess: ProtonBoolean, 
        rightToLeft: MailSettingsComposerDirection, 
        attachPublicKey: ProtonBoolean, 
        sign: ProtonBoolean, 
        pgpScheme: MailSettingsPgpScheme, 
        promptPin: ProtonBoolean, 
        stickyLabels: ProtonBoolean, 
        confirmLink: ProtonBoolean, 
        delaySendSeconds: UInt32, 
        fontFace: String?, 
        spamAction: MailSettingsSpamAction?, 
        blockSenderConfirmation: ProtonBoolean?, 
        mobileSettings: MailSettingsMobileSettings?, 
        hideRemoteImages: ProtonBoolean, 
        hideSenderImages: ProtonBoolean) {
...
public struct FfiConverterTypeMailSettings: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> MailSettings {
        return
            try MailSettings(
                ...
                autoSaveContacts: FfiConverterTypeProtonBoolean.read(from: &buf), 
                ...
                shortcuts: FfiConverterTypeProtonBoolean.read(from: &buf), 
                pmSignature: FfiConverterTypeMailSettingsPMSignature.read(from: &buf), 
                pmSignatureReferralLink: FfiConverterTypeProtonBoolean.read(from: &buf), 
                ...
                enableFolderColor: FfiConverterTypeProtonBoolean.read(from: &buf), 
                inheritParentFolderColor: FfiConverterTypeProtonBoolean.read(from: &buf), 
                submissionAccess: FfiConverterTypeProtonBoolean.read(from: &buf), 
                rightToLeft: FfiConverterTypeMailSettingsComposerDirection.read(from: &buf), 
                attachPublicKey: FfiConverterTypeProtonBoolean.read(from: &buf), 
                sign: FfiConverterTypeProtonBoolean.read(from: &buf), 
                pgpScheme: FfiConverterTypeMailSettingsPGPScheme.read(from: &buf), 
                promptPin: FfiConverterTypeProtonBoolean.read(from: &buf), 
                stickyLabels: FfiConverterTypeProtonBoolean.read(from: &buf), 
                confirmLink: FfiConverterTypeProtonBoolean.read(from: &buf), 
                ...
                blockSenderConfirmation: FfiConverterOptionTypeProtonBoolean.read(from: &buf), 
                mobileSettings: FfiConverterOptionTypeMailSettingsMobileSettings.read(from: &buf), 
                hideRemoteImages: FfiConverterTypeProtonBoolean.read(from: &buf), 
                hideSenderImages: FfiConverterTypeProtonBoolean.read(from: &buf)
        )
    }
    ...
    public static func write(_ value: MailSettings, into buf: inout [UInt8]) {
        ...
        FfiConverterTypeProtonBoolean.write(value.autoSaveContacts, into: &buf)
        ...
        FfiConverterTypeProtonBoolean.write(value.shortcuts, into: &buf)
        FfiConverterTypeMailSettingsPMSignature.write(value.pmSignature, into: &buf)
        FfiConverterTypeProtonBoolean.write(value.pmSignatureReferralLink, into: &buf)
        ...
        FfiConverterTypeProtonBoolean.write(value.enableFolderColor, into: &buf)
        FfiConverterTypeProtonBoolean.write(value.inheritParentFolderColor, into: &buf)
        FfiConverterTypeProtonBoolean.write(value.submissionAccess, into: &buf)
        FfiConverterTypeMailSettingsComposerDirection.write(value.rightToLeft, into: &buf)
        FfiConverterTypeProtonBoolean.write(value.attachPublicKey, into: &buf)
        FfiConverterTypeProtonBoolean.write(value.sign, into: &buf)
        FfiConverterTypeMailSettingsPGPScheme.write(value.pgpScheme, into: &buf)
        FfiConverterTypeProtonBoolean.write(value.promptPin, into: &buf)
        FfiConverterTypeProtonBoolean.write(value.stickyLabels, into: &buf)
        FfiConverterTypeProtonBoolean.write(value.confirmLink, into: &buf)
        ...
        FfiConverterTypeProtonBoolean.write(value.hideRemoteImages, into: &buf)
        FfiConverterTypeProtonBoolean.write(value.hideSenderImages, into: &buf)
    }
}
...
public struct MailSettingsMobileSettings {
    ...
    // declare one manually.
    public init(
        messageToolbar: MailSettingsMobileSetting, 
        conversationToolbar: MailSettingsMobileSetting, 
        listToolbar: MailSettingsMobileSetting) {
...
public struct MessageAddress {
    ...
    public var name: String
    public var isProton: ProtonBoolean
    public var displaySenderImage: ProtonBoolean
    public var isSimpleLogin: ProtonBoolean
    ...
    public init(
        address: String, 
        name: String, 
        isProton: ProtonBoolean, 
        displaySenderImage: ProtonBoolean, 
        isSimpleLogin: ProtonBoolean, 
        bimiSelector: String?) {
...
public struct FfiConverterTypeMessageAddress: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> MessageAddress {
        return
            try MessageAddress(
                ...
                name: FfiConverterString.read(from: &buf), 
                isProton: FfiConverterTypeProtonBoolean.read(from: &buf), 
                displaySenderImage: FfiConverterTypeProtonBoolean.read(from: &buf), 
                isSimpleLogin: FfiConverterTypeProtonBoolean.read(from: &buf), 
    ...
    public static func write(_ value: MessageAddress, into buf: inout [UInt8]) {
        ...
        FfiConverterString.write(value.name, into: &buf)
        FfiConverterTypeProtonBoolean.write(value.isProton, into: &buf)
        FfiConverterTypeProtonBoolean.write(value.displaySenderImage, into: &buf)
        FfiConverterTypeProtonBoolean.write(value.isSimpleLogin, into: &buf)
...
public struct MessageMetadata {
    ...
    public var size: UInt64
    public var unread: ProtonBoolean
    public var isReplied: ProtonBoolean
    public var isRepliedAll: ProtonBoolean
    public var isForwarded: ProtonBoolean
    ...
    public init(
        ...
        time: UInt64, 
        size: UInt64, 
        unread: ProtonBoolean, 
        isReplied: ProtonBoolean, 
        isRepliedAll: ProtonBoolean, 
        isForwarded: ProtonBoolean, 
...
public struct FfiConverterTypeMessageMetadata: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> MessageMetadata {
        return
            try MessageMetadata(
                ...
                size: FfiConverterUInt64.read(from: &buf), 
                unread: FfiConverterTypeProtonBoolean.read(from: &buf), 
                isReplied: FfiConverterTypeProtonBoolean.read(from: &buf), 
                isRepliedAll: FfiConverterTypeProtonBoolean.read(from: &buf), 
                isForwarded: FfiConverterTypeProtonBoolean.read(from: &buf), 
    ...
    public static func write(_ value: MessageMetadata, into buf: inout [UInt8]) {
        ...
        FfiConverterUInt64.write(value.size, into: &buf)
        FfiConverterTypeProtonBoolean.write(value.unread, into: &buf)
        FfiConverterTypeProtonBoolean.write(value.isReplied, into: &buf)
        FfiConverterTypeProtonBoolean.write(value.isRepliedAll, into: &buf)
        FfiConverterTypeProtonBoolean.write(value.isForwarded, into: &buf)
...
// Note that we don't yet support `indirect` for enums.
// See https://github.com/mozilla/uniffi-rs/issues/396 for further discussion.
public enum MailSettingsAlmostAllMail {
...
// Note that we don't yet support `indirect` for enums.
// See https://github.com/mozilla/uniffi-rs/issues/396 for further discussion.
public enum MailSettingsComposerDirection {
...
// Note that we don't yet support `indirect` for enums.
// See https://github.com/mozilla/uniffi-rs/issues/396 for further discussion.
public enum MailSettingsComposerMode {
...
// Note that we don't yet support `indirect` for enums.
// See https://github.com/mozilla/uniffi-rs/issues/396 for further discussion.
public enum MailSettingsMessageButtons {
...
// Note that we don't yet support `indirect` for enums.
// See https://github.com/mozilla/uniffi-rs/issues/396 for further discussion.
public enum MailSettingsNextMessageOnMove {
...
// Note that we don't yet support `indirect` for enums.
// See https://github.com/mozilla/uniffi-rs/issues/396 for further discussion.
public enum MailSettingsPgpScheme {
...
// Note that we don't yet support `indirect` for enums.
// See https://github.com/mozilla/uniffi-rs/issues/396 for further discussion.
public enum MailSettingsPmSignature {
...
// Note that we don't yet support `indirect` for enums.
// See https://github.com/mozilla/uniffi-rs/issues/396 for further discussion.
public enum MailSettingsShowImages {
...
// Note that we don't yet support `indirect` for enums.
// See https://github.com/mozilla/uniffi-rs/issues/396 for further discussion.
public enum MailSettingsShowMoved {
...
// Note that we don't yet support `indirect` for enums.
// See https://github.com/mozilla/uniffi-rs/issues/396 for further discussion.
public enum MailSettingsSpamAction {
...
// Note that we don't yet support `indirect` for enums.
// See https://github.com/mozilla/uniffi-rs/issues/396 for further discussion.
public enum MailSettingsSwipeAction {
...
// Note that we don't yet support `indirect` for enums.
// See https://github.com/mozilla/uniffi-rs/issues/396 for further discussion.
public enum MailSettingsViewLayout {
...
// Note that we don't yet support `indirect` for enums.
// See https://github.com/mozilla/uniffi-rs/issues/396 for further discussion.
public enum MailSettingsViewMode {
...
fileprivate struct FfiConverterOptionTypeProtonBoolean: FfiConverterRustBuffer {
    ...
    public static func write(_ value: SwiftType, into buf: inout [UInt8]) {
        ...
        writeInt(&buf, Int8(1))
        FfiConverterTypeProtonBoolean.write(value, into: &buf)
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> SwiftType {
        switch try readInt(&buf) as Int8 {
        case 0: return nil
        case 1: return try FfiConverterTypeProtonBoolean.read(from: &buf)
        default: throw UniffiInternalError.unexpectedOptionalTag
        }
    }
}
