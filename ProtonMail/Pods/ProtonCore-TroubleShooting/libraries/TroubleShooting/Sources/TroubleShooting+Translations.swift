...
public enum TSTranslation: TranslationsExposing {
    ...
    public var l10n: String {
        switch self {
        case ._troubleshooting_support_from:
            return localized(key: "support form", comment: "network troubleshot view title")
        case ._troubleshooting_email_title:
            return localized(key: "email", comment: "network troubleshot view title")
        case ._troubleshooting_twitter_title:
            return localized(key: "Twitter", comment: "network troubleshot view title")
        case ._troubleshooting_title:
            return localized(key: "TroubleShooting", comment: "network troubleshot view title")
        case ._allow_alternative_routing:
            return localized(key: "Allow alternative routing", comment: "network troubleshot cell title")
        case ._no_internet_connection:
            return localized(key: "No internet connection", comment: "network troubleshot cell title")
        case ._isp_problem:
            return localized(key: "Internet Service Provider (ISP) problem", comment: "network troubleshot cell title")
        case ._gov_block:
            return localized(key: "Government block", comment: "network troubleshot cell title")
        case ._antivirus_interference:
            return localized(key: "Antivirus interference", comment: "network troubleshot cell title")
        case ._firewall_interference:
            return localized(key: "Proxy/Firewall interference", comment: "network troubleshot cell title")
        case ._proton_is_down:
            return localized(key: "Proton is down", comment: "network troubleshot cell title")
        case ._no_solution:
            return localized(key: "Still can't find a solution", comment: "network troubleshot cell title")
        case ._allow_alternative_routing_description:
