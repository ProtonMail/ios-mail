...
public protocol ICalValueWriterProtocol where Self: AnyObject {
    var value: OpaquePointer { get }
...
public extension ICalValueWriterProtocol {
    var ics: String {
        String(cString: icalvalue_as_ical_string(value))
    }
}
