//
//  SSOObtainChallengeTokenEvent.swift
...
public enum SSOObtainChallengeTokenStatus: String, Encodable, CaseIterable {
    case http2xx
    case http4xx
    case http5xx
    case ssoDomainNotFound
    case unknown
}

public struct SSOObtainChallengeTokenLabels: Encodable, Equatable {
    let status: SSOObtainChallengeTokenStatus
...
extension ObservabilityEvent where Payload == PayloadWithLabels<SSOObtainChallengeTokenLabels> {
