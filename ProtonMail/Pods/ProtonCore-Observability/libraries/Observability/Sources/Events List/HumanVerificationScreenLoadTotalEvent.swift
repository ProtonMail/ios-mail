...
public struct HumanVerificationScreenLoadLabels: Encodable, Equatable {
    let status: SuccessOrFailureStatus
}

extension ObservabilityEvent where Payload == PayloadWithLabels<HumanVerificationScreenLoadLabels> {
