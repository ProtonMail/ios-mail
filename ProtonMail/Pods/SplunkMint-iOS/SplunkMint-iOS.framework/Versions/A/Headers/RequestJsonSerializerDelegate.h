...
@required
    ...
    - (SerializeResult*) serializeCrashToJson: (NSException*)exception appEnvironment: (MintAppEnvironment*)anAppEnvironment performance: (MintPerformance*)aPerformance handled: (BOOL)isHandled crashExtraDataList: (LimitedExtraDataList*) extraData;
