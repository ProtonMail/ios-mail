...
extension UIColorManager {
    ...
    private static let Woodsmoke = UIColor(named: "Woodsmoke", in: PMUIFoundations.bundle, compatibleWith: nil)!
    ...
    private static let White = UIColor(named: "White", in: PMUIFoundations.bundle, compatibleWith: nil)!
