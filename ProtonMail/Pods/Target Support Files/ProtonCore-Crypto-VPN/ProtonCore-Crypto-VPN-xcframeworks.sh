...
install_xcframework "${PODS_ROOT}/ProtonCore-Crypto-VPN/vendor/Crypto_VPN/Crypto_VPN.xcframework" "ProtonCore-Crypto-VPN" "framework" "ios-arm64_x86_64-simulator" "ios-arm64" "ios-arm64_x86_64-maccatalyst"
