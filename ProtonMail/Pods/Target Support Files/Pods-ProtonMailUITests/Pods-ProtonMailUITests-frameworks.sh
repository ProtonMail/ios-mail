...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ProtonCore-FeatureSwitch/ProtonCoreFeatureSwitch.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ProtonCore-Subscriptions/ProtonCoreSubscriptions.framework"
