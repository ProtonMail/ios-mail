...
install_xcframework "${PODS_ROOT}/ProtonCore-Crypto/vendor/Crypto/Crypto.xcframework" "Crypto" "framework" "ios-arm64_x86_64-simulator" "ios-arm64_x86_64-maccatalyst" "ios-arm64"
