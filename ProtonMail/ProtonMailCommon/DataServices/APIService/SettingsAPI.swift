...
//MARK : update display name, seems deprecated
final class UpdateDisplayNameRequest : ApiRequest<ApiResponse> {
    ...
    override func path() -> String {
        return SettingsAPI.path + "/display" + Constants.App.DEBUG_OPTION
    }
...
final class UpdateShowImages : ApiRequest<ApiResponse> {
    ...
    override func path() -> String {
        return SettingsAPI.path + "/images" + Constants.App.DEBUG_OPTION
    }
...
final class UpdateLinkConfirmation : ApiRequest<ApiResponse> {
    ...
    override func path() -> String {
        return SettingsAPI.path + "/confirmlink" + Constants.App.DEBUG_OPTION
    }
...
final class UpdateSwiftLeftAction : ApiRequest<ApiResponse> {
    ...
    override func path() -> String {
        return SettingsAPI.path + "/swipeleft" + Constants.App.DEBUG_OPTION
    }
...
final class UpdateSwiftRightAction : ApiRequest<ApiResponse> {
    ...
    override func path() -> String {
        return SettingsAPI.path + "/swiperight" + Constants.App.DEBUG_OPTION
    }
