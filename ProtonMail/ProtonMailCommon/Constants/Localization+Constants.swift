...
class LocalizedString {
  ...
  NSLocalizedString("System can't copy the file", comment: "Error")
    ...
    lazy var _unlock_to_proceed_tiwh_iap = NSLocalizedString("Please unlock the app to proceed with your service plan activation", comment: "Error message")
    
    lazy var _please_sign_in_iap = NSLocalizedString("Please login into the ProtonMail account you're upgrading the service plan for so we'll be able to complete the service plan activation", comment: "Error message")
