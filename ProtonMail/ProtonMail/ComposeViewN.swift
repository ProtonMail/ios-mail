...
@objc protocol ComposeViewNDelegate {
    
    optional func ComposeViewNDidSizeChanged(size: CGSize)
...
//        }
    ...
    ///
    internal func notifyViewSize()
    {
        UIView.animateWithDuration(self.kAnimationDuration, delay:0, options: nil, animations: {
            //143
