...
class EmailService {
    ...
    class func retrieveMessages() -> [EmailThread] {
        var messages: [EmailThread] = [
            ...
            EmailThread(id: "2", title:"More tips for hiring!", sender: "Rafael Corrales", time: "7:36pm", hasAttachments: true, isEncrypted: true),
            EmailThread(id: "3", title:"Re: ProtonMail iOS/Android, without using HTML", sender: "Riachard TETAZ", time: "7:36pm"),
            EmailThread(id: "4", title:"RE: Front End - Stanford - Kilometers", sender: "Ryan Neely", time: "7:36pm", hasAttachments: true, isEncrypted: true),
            EmailThread(id: "5", title:"Wireframe Status | Monday report", sender: "Elizabeth Kintzele (GF)", time: "7:36pm", hasAttachments: false, isEncrypted: true, isFavorite: true),
            ...
            EmailThread(id: "7", title:"Happy Holidays!", sender: "Elizabeth Kintzele (GF)", time: "7:36pm", hasAttachments: true, isEncrypted: true, isFavorite: true),
            EmailThread(id: "8", title:"More tips for hiring!", sender: "Rafael Corrales", time: "7:36pm", hasAttachments: true, isEncrypted: true),
            EmailThread(id: "9", title:"Re: ProtonMail iOS/Android, without using HTML", sender: "Riachard TETAZ", time: "7:36pm"),
