...
class MessageHelpersTest: XCTestCase {
    ...
    var testContext: NSManagedObjectContext!
       ...
       func testRecipientsNameWithGroup() {
           ...
           let name = fakeMsg.allEmailAddresses([fakeEmail], groupContacts: [vo])
           XCTAssertEqual("groupA (5/5), test5", name)
       }
    ...
    func testRecipientsNameWithoutGroup_localContactWithoutTheAddress() {
        ...
        let name = fakeMsg.allEmailAddresses([fakeEmail], groupContacts: [])
