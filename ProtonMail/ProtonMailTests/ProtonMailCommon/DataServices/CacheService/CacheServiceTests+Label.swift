...
extension CacheServiceTest {
    func testUpdateLabel() throws {
        ...
        let labelToCheck = try XCTUnwrap(Label.labelForLableID("labelID", inManagedObjectContext: testContext))
    ...
    func testDeleteLabel() throws {
        ...
        XCTAssertNil(Label.labelForLableID("labelID", inManagedObjectContext: testContext))
    }
